...
static_assert(alignof(IAudioMotorSim) == 0x000001, "Wrong alignment on IAudioMotorSim");
static_assert(sizeof(IAudioMotorSim) == 0x000001, "Wrong size on IAudioMotorSim");
...
static_assert(alignof(IAudioMotorSimOutput) == 0x000001, "Wrong alignment on IAudioMotorSimOutput");
static_assert(sizeof(IAudioMotorSimOutput) == 0x000001, "Wrong size on IAudioMotorSimOutput");
