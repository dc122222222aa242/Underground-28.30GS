...
static_assert(alignof(IVehicleAudioLifecycleInterface) == 0x000001, "Wrong alignment on IVehicleAudioLifecycleInterface");
static_assert(sizeof(IVehicleAudioLifecycleInterface) == 0x000001, "Wrong size on IVehicleAudioLifecycleInterface");
