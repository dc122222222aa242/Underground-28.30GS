...
static_assert(alignof(IGrappleKnifeWeaponInterface) == 0x000001, "Wrong alignment on IGrappleKnifeWeaponInterface");
static_assert(sizeof(IGrappleKnifeWeaponInterface) == 0x000001, "Wrong size on IGrappleKnifeWeaponInterface");
