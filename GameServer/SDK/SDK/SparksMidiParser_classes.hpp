...
static_assert(alignof(IMidiEventDriverInterface) == 0x000001, "Wrong alignment on IMidiEventDriverInterface");
static_assert(sizeof(IMidiEventDriverInterface) == 0x000001, "Wrong size on IMidiEventDriverInterface");
