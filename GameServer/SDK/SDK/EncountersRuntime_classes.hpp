...
static_assert(alignof(IEncounterPointProviderInterface) == 0x000001, "Wrong alignment on IEncounterPointProviderInterface");
static_assert(sizeof(IEncounterPointProviderInterface) == 0x000001, "Wrong size on IEncounterPointProviderInterface");
