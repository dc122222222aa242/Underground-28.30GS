...
static_assert(alignof(IFabricAnimatableButtonInterface) == 0x000001, "Wrong alignment on IFabricAnimatableButtonInterface");
static_assert(sizeof(IFabricAnimatableButtonInterface) == 0x000001, "Wrong size on IFabricAnimatableButtonInterface");
...
static_assert(alignof(IFabricDevice) == 0x000001, "Wrong alignment on IFabricDevice");
static_assert(sizeof(IFabricDevice) == 0x000001, "Wrong size on IFabricDevice");
...
static_assert(alignof(IFabricMetaSoundPatchOwner) == 0x000001, "Wrong alignment on IFabricMetaSoundPatchOwner");
static_assert(sizeof(IFabricMetaSoundPatchOwner) == 0x000001, "Wrong size on IFabricMetaSoundPatchOwner");
...
static_assert(alignof(IFabricAudioGenerator) == 0x000001, "Wrong alignment on IFabricAudioGenerator");
static_assert(sizeof(IFabricAudioGenerator) == 0x000001, "Wrong size on IFabricAudioGenerator");
...
static_assert(alignof(IFabricAudioModifier) == 0x000001, "Wrong alignment on IFabricAudioModifier");
static_assert(sizeof(IFabricAudioModifier) == 0x000001, "Wrong size on IFabricAudioModifier");
...
static_assert(alignof(IFabricAudioReceiver) == 0x000001, "Wrong alignment on IFabricAudioReceiver");
static_assert(sizeof(IFabricAudioReceiver) == 0x000001, "Wrong size on IFabricAudioReceiver");
...
static_assert(alignof(IFabricFloatGenerator) == 0x000001, "Wrong alignment on IFabricFloatGenerator");
static_assert(sizeof(IFabricFloatGenerator) == 0x000001, "Wrong size on IFabricFloatGenerator");
...
static_assert(alignof(IFabricFloatReceiver) == 0x000001, "Wrong alignment on IFabricFloatReceiver");
static_assert(sizeof(IFabricFloatReceiver) == 0x000001, "Wrong size on IFabricFloatReceiver");
...
static_assert(alignof(IFabricTextureGenerator) == 0x000001, "Wrong alignment on IFabricTextureGenerator");
static_assert(sizeof(IFabricTextureGenerator) == 0x000001, "Wrong size on IFabricTextureGenerator");
...
static_assert(alignof(IFabricTextureModifier) == 0x000001, "Wrong alignment on IFabricTextureModifier");
static_assert(sizeof(IFabricTextureModifier) == 0x000001, "Wrong size on IFabricTextureModifier");
...
static_assert(alignof(IFabricTextureReceiver) == 0x000001, "Wrong alignment on IFabricTextureReceiver");
static_assert(sizeof(IFabricTextureReceiver) == 0x000001, "Wrong size on IFabricTextureReceiver");
...
static_assert(alignof(IFabricMeshGenerator) == 0x000001, "Wrong alignment on IFabricMeshGenerator");
static_assert(sizeof(IFabricMeshGenerator) == 0x000001, "Wrong size on IFabricMeshGenerator");
...
static_assert(alignof(IFabricMeshModifier) == 0x000001, "Wrong alignment on IFabricMeshModifier");
static_assert(sizeof(IFabricMeshModifier) == 0x000001, "Wrong size on IFabricMeshModifier");
...
static_assert(alignof(IFabricMeshReceiver) == 0x000001, "Wrong alignment on IFabricMeshReceiver");
static_assert(sizeof(IFabricMeshReceiver) == 0x000001, "Wrong size on IFabricMeshReceiver");
...
public:
	...
	TMulticastInlineDelegate<void(float      )>   OnFloatChanged;                                    // 0x0330(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(alignof(IFabricHoldable) == 0x000001, "Wrong alignment on IFabricHoldable");
static_assert(sizeof(IFabricHoldable) == 0x000001, "Wrong size on IFabricHoldable");
...
static_assert(alignof(IFabricInteractable) == 0x000001, "Wrong alignment on IFabricInteractable");
static_assert(sizeof(IFabricInteractable) == 0x000001, "Wrong size on IFabricInteractable");
...
static_assert(alignof(IFabricModulator) == 0x000001, "Wrong alignment on IFabricModulator");
static_assert(sizeof(IFabricModulator) == 0x000001, "Wrong size on IFabricModulator");
...
static_assert(alignof(IFabricModulatorSource) == 0x000001, "Wrong alignment on IFabricModulatorSource");
static_assert(sizeof(IFabricModulatorSource) == 0x000001, "Wrong size on IFabricModulatorSource");
...
static_assert(alignof(IFabricModulatorDevice) == 0x000001, "Wrong alignment on IFabricModulatorDevice");
static_assert(sizeof(IFabricModulatorDevice) == 0x000001, "Wrong size on IFabricModulatorDevice");
