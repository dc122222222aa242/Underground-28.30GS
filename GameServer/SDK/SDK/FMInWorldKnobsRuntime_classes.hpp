...
static_assert(alignof(IInWorldKnobInterface) == 0x000001, "Wrong alignment on IInWorldKnobInterface");
static_assert(sizeof(IInWorldKnobInterface) == 0x000001, "Wrong size on IInWorldKnobInterface");
