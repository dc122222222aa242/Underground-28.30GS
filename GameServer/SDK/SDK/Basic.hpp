...
public:
	...
	inline FUObjectItem* GetItemByIndex(int32 Index) {
		const int32 ChunkIndex = Index / ElementsPerChunk;
		const int32 InChunkIdx = Index % ElementsPerChunk;
...
public:
	...
	{
		auto res = this->ComparisonIndex == Rhs.ComparisonIndex ? *(uint32*)(__int64(this)+ 0x0004) < *(uint32*)(__int64(&Rhs) + 0x0004) : this->ComparisonIndex < Rhs.ComparisonIndex;
		return res;
	}
};
...
public:
	...
	FORCEINLINE TWeakObjectPtr& operator=(UEType* Object)
	{
		if (!Object)
			return *this;
		UEType* TempObject = Object;
		this->ObjectIndex = Object->Index;
		this->ObjectSerialNumber = UObject::GObjects->GetItemByIndex(this->ObjectIndex)->SerialNumber;
		return *this;
	}
};
...
public:
	...
	std::string GetAssetPathName() {
		return AssetPath.PackageName.GetRawString().append(".").append(AssetPath.AssetName.GetRawString());
	}
};
