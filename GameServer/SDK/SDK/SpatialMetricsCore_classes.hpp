...
static_assert(alignof(ISpatialMetricsActorIndexerSubscriber) == 0x000001, "Wrong alignment on ISpatialMetricsActorIndexerSubscriber");
static_assert(sizeof(ISpatialMetricsActorIndexerSubscriber) == 0x000001, "Wrong size on ISpatialMetricsActorIndexerSubscriber");
...
static_assert(alignof(ISpatialMetricsActorTrackerSubscriber) == 0x000001, "Wrong alignment on ISpatialMetricsActorTrackerSubscriber");
static_assert(sizeof(ISpatialMetricsActorTrackerSubscriber) == 0x000001, "Wrong size on ISpatialMetricsActorTrackerSubscriber");
