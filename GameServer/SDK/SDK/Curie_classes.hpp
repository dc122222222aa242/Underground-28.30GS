...
static_assert(alignof(ICurieManagerComponentInterface) == 0x000001, "Wrong alignment on ICurieManagerComponentInterface");
static_assert(sizeof(ICurieManagerComponentInterface) == 0x000001, "Wrong size on ICurieManagerComponentInterface");
