...
static_assert(alignof(ISparksDrumEventsInterface) == 0x000001, "Wrong alignment on ISparksDrumEventsInterface");
static_assert(sizeof(ISparksDrumEventsInterface) == 0x000001, "Wrong size on ISparksDrumEventsInterface");
