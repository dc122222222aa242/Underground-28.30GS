...
static_assert(alignof(IJunoPersistenceFeatureWorldMetadataCorrespondentInterface) == 0x000001, "Wrong alignment on IJunoPersistenceFeatureWorldMetadataCorrespondentInterface");
static_assert(sizeof(IJunoPersistenceFeatureWorldMetadataCorrespondentInterface) == 0x000001, "Wrong size on IJunoPersistenceFeatureWorldMetadataCorrespondentInterface");
