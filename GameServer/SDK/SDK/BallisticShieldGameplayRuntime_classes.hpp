...
static_assert(alignof(IBallisticShieldWeaponInterface) == 0x000001, "Wrong alignment on IBallisticShieldWeaponInterface");
static_assert(sizeof(IBallisticShieldWeaponInterface) == 0x000001, "Wrong size on IBallisticShieldWeaponInterface");
