...
static_assert(alignof(IBuoyancyEventInterface) == 0x000001, "Wrong alignment on IBuoyancyEventInterface");
static_assert(sizeof(IBuoyancyEventInterface) == 0x000001, "Wrong size on IBuoyancyEventInterface");
