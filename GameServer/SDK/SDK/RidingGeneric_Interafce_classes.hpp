...
static_assert(alignof(IRidingGeneric_Interafce_C) == 0x000001, "Wrong alignment on IRidingGeneric_Interafce_C");
static_assert(sizeof(IRidingGeneric_Interafce_C) == 0x000001, "Wrong size on IRidingGeneric_Interafce_C");
