...
static_assert(alignof(ICrewScreenContentBlockingInterface) == 0x000001, "Wrong alignment on ICrewScreenContentBlockingInterface");
static_assert(sizeof(ICrewScreenContentBlockingInterface) == 0x000001, "Wrong size on ICrewScreenContentBlockingInterface");
...
static_assert(alignof(IFortProgressiveContentInterface) == 0x000001, "Wrong alignment on IFortProgressiveContentInterface");
static_assert(sizeof(IFortProgressiveContentInterface) == 0x000001, "Wrong size on IFortProgressiveContentInterface");
