...
static_assert(alignof(IVehicleCosmeticsAudioUser) == 0x000001, "Wrong alignment on IVehicleCosmeticsAudioUser");
static_assert(sizeof(IVehicleCosmeticsAudioUser) == 0x000001, "Wrong size on IVehicleCosmeticsAudioUser");
