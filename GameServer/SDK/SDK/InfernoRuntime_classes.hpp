...
static_assert(alignof(IFortCurieVoxelFireDebugParticleDataInterface) == 0x000001, "Wrong alignment on IFortCurieVoxelFireDebugParticleDataInterface");
static_assert(sizeof(IFortCurieVoxelFireDebugParticleDataInterface) == 0x000001, "Wrong size on IFortCurieVoxelFireDebugParticleDataInterface");
...
static_assert(alignof(IFortCurieVoxelFireParticleDataInterface) == 0x000001, "Wrong alignment on IFortCurieVoxelFireParticleDataInterface");
static_assert(sizeof(IFortCurieVoxelFireParticleDataInterface) == 0x000001, "Wrong size on IFortCurieVoxelFireParticleDataInterface");
...
static_assert(alignof(IInfernoCurieVoxelFireAudioParticleDataInterface) == 0x000001, "Wrong alignment on IInfernoCurieVoxelFireAudioParticleDataInterface");
static_assert(sizeof(IInfernoCurieVoxelFireAudioParticleDataInterface) == 0x000001, "Wrong size on IInfernoCurieVoxelFireAudioParticleDataInterface");
