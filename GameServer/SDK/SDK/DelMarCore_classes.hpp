...
static_assert(alignof(IDelMarVehicleInterface) == 0x000001, "Wrong alignment on IDelMarVehicleInterface");
static_assert(sizeof(IDelMarVehicleInterface) == 0x000001, "Wrong size on IDelMarVehicleInterface");
