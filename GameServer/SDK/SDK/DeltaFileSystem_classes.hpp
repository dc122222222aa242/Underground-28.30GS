...
static_assert(alignof(IDeltaFileApplier) == 0x000001, "Wrong alignment on IDeltaFileApplier");
static_assert(sizeof(IDeltaFileApplier) == 0x000001, "Wrong size on IDeltaFileApplier");
