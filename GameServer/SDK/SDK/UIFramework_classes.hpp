...
static_assert(alignof(IUIFrameworkWidgetWrapperInterface) == 0x000001, "Wrong alignment on IUIFrameworkWidgetWrapperInterface");
static_assert(sizeof(IUIFrameworkWidgetWrapperInterface) == 0x000001, "Wrong size on IUIFrameworkWidgetWrapperInterface");
