...
{
public:
	static inline void (*ProcessEventOG)(UObject* Object, UFunction* Function, void* Parameters);
...
public:
	...
	{
		//if (!ProcessEventOG)
			ProcessEventOG((UObject*)this, Function, Parms);
		//else
...
public:
	...
	class UFunction* FindFunction(const std::string& FuncName) const;
